...
Этот проект создан в рамках технического задания inDrive для повышения безопасности, доверия пассажиров и качества сервиса.
...
**Загрузите тестовые изображения из папки `user_data/`:**
